...
public class signupseller1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        brandmobile = findViewById(R.id.brandMobile);
        brandemail = findViewById(R.id.brandEmailId);
        brandpassword = findViewById(R.id.brandCreatePassword);
        brandConfirmPassword = findViewById(R.id.brandConfirmPassword);
        Button buttonnext = findViewById(R.id.createSellerAccountFinalButton);
        Button uploadImage = findViewById(R.id.selectimagebutton);
        uploadedImage= findViewById(R.id.selectimageview);
